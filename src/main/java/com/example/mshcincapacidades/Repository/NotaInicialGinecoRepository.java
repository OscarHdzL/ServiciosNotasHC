...
public interface NotaInicialGinecoRepository extends MongoRepository<NotaInicialGinecologia, String>{
...
List<NotaInicialGinecologia> findNotasInicialGineco(String num_nss, String agregado_medico, String num_exp_folio, String num_exp_anio, String num_exp_unidado);
...
NotaInicialGinecologiaDetail findNotaInicialGinecologiaById(String id);
